...
def default_key_func(key, key_prefix, version): # -> str:
    """
...
def get_key_func(key_func): # -> Any | ((key: Unknown, key_prefix: Unknown, version: Unknown) -> str):
    """
...
class BaseCache:
    ...
    def make_key(self, key, version=...): # -> Any | str:
        """
    ...
    def make_and_validate_key(self, key, version=...): # -> Any | str:
