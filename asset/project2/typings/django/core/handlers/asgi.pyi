...
class ASGIHandler(base.BaseHandler):
    ...
    async def read_body(self, receive): # -> SpooledTemporaryFile[Unknown]:
    ...
    @classmethod
    def chunk_bytes(cls, data): # -> Generator[tuple[Unknown, Literal[True]] | tuple[Unknown, bool], None, None]:
        """
    ...
    def get_script_prefix(self, scope): # -> Any | str:
        """
