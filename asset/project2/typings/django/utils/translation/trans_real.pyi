...
def gettext(message): # -> Any | ((*args: Unknown, **kwargs: Unknown) -> Unknown) | SafeString:
    """
...
def pgettext(context, message): # -> Any | ((*args: Unknown, **kwargs: Unknown) -> Unknown) | SafeString | str:
    ...
...
@functools.lru_cache()
def get_languages(): # -> dict[Unknown, Unknown]:
    """
...
def get_language_from_path(path, strict=...): # -> None:
    """
