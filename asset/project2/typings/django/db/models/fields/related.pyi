...
class ForeignObject(RelatedField):
    ...
    def get_attname_column(self): # -> tuple[Unknown, None]:
        ...
...
class ForeignKey(ForeignObject):
    ...
    def formfield(self, *, using=..., **kwargs):
        ...
    
    def db_check(self, connection): # -> list[Unknown]:
        ...
...
def create_many_to_many_intermediary_model(field, klass): # -> Type[_]:
    ...
