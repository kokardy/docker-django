...
class Field(RegisterLookupMixin):
    ...
    def deconstruct(self): # -> tuple[Unknown, str, list[Unknown], dict[Unknown, Unknown]]:
        """
    ...
    def __reduce__(self): # -> tuple[(of_cls: Unknown) -> Empty, tuple[Type[Self@Field]], dict[str, Any]] | tuple[(app_label: Unknown, model_name: Unknown, field_name: Unknown) -> Unknown, tuple[Unknown, Unknown, Unknown]]:
        """
    ...
    @property
    def unique(self): # -> Unknown:
        ...
    
    @property
    def db_tablespace(self): # -> Any | str:
        ...
    ...
    def get_filter_kwargs_for_object(self, obj): # -> dict[Unknown, Any]:
        """
