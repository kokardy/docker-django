...
class BaseExpression:
    ...
    def get_group_by_cols(self, alias=...): # -> list[Self@BaseExpression]:
        ...
...
class Expression(BaseExpression, Combinable):
    ...
    @cached_property
    def identity(self): # -> tuple[Type[Self@Expression], ...]:
        ...
...
class OuterRef(F):
    contains_aggregate = ...
    def resolve_expression(self, *args, **kwargs): # -> Self@OuterRef | ResolvedOuterRef:
        ...
...
class Value(SQLiteNumericMixin, Expression):
    ...
    def resolve_expression(self, query=..., allow_joins=..., reuse=..., summarize=..., for_save=...): # -> Value:
        ...
...
class RawSQL(Expression):
    ...
    def resolve_expression(self, query=..., allow_joins=..., reuse=..., summarize=..., for_save=...): # -> RawSQL:
        ...
...
class Col(Expression):
    ...
    def relabeled_clone(self, relabels): # -> Self@Col:
        ...
...
class ExpressionWrapper(Expression):
    ...
    def get_group_by_cols(self, alias=...): # -> list[Expression] | list[ExpressionWrapper]:
        ...
...
class Case(Expression):
    ...
    def resolve_expression(self, query=..., allow_joins=..., reuse=..., summarize=..., for_save=...): # -> Case:
        ...
    ...
    def get_group_by_cols(self, alias=...): # -> list[Case]:
        ...
...
class Subquery(BaseExpression, Combinable):
    ...
    def get_source_expressions(self): # -> list[Any | Unknown | None]:
        ...
    ...
    def get_group_by_cols(self, alias=...): # -> list[Ref] | list[Self@Subquery] | Any:
        ...
...
class Exists(Subquery):
    ...
    def as_sql(self, compiler, connection, template=..., **extra_context): # -> tuple[str | Unknown, Any | Unknown]:
        ...
...
class OrderBy(Expression):
    ...
    def as_oracle(self, compiler, connection): # -> tuple[str, Unknown]:
        ...
...
class Window(SQLiteNumericMixin, Expression):
    ...
    def as_sql(self, compiler, connection, template=...): # -> tuple[Unknown | str, Unknown]:
        ...
    
    def as_sqlite(self, compiler, connection): # -> tuple[Unknown, Unknown] | tuple[str, Unknown]:
        ...
