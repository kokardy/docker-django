...
class ModelStateFieldsCacheDescriptor:
    def __get__(self, instance, cls=...): # -> Self@ModelStateFieldsCacheDescriptor | dict[Unknown, Unknown]:
        ...
...
class Model(metaclass=ModelBase):
    ...
    @classmethod
    def from_db(cls, db, field_names, values): # -> Self@Model:
        ...
    ...
    def __reduce__(self): # -> tuple[(model_id: Unknown) -> Unknown, tuple[tuple[Unknown, Unknown]], dict[str, Any]]:
        ...
    ...
    def delete(self, using=..., keep_parents=...): # -> tuple[Any | int, dict[Unknown, Any | int]] | tuple[int, dict[Unknown, int]]:
        ...
    ...
    @classmethod
    def check(cls, **kwargs): # -> list[Unknown]:
        ...
