...
class QuerySet:
    ...
    as_manager = ...
    def __deepcopy__(self, memo): # -> Self@QuerySet:
    ...
    def __iter__(self): # -> Iterator[dict[Unknown, Unknown]]:
        """
    ...
    def __and__(self, other): # -> EmptyQuerySet | <subclass of QuerySet and EmptyQuerySet>* | Self@QuerySet:
        ...
    
    def __or__(self, other): # -> Self@QuerySet:
        ...
    ...
    def update_or_create(self, defaults=..., **kwargs): # -> tuple[Unknown, Unknown] | tuple[Unknown, Literal[False]]:
        """
    ...
    def delete(self): # -> tuple[Any | int, dict[Unknown, Any | int] | dict[Unknown, int]]:
    ...
    def values(self, *fields, **expressions): # -> Self@QuerySet:
        ...
    ...
    def none(self): # -> Self@QuerySet:
        """Return an empty QuerySet."""
        ...
    
    def all(self): # -> Self@QuerySet:
        """
    ...
    def filter(self, *args, **kwargs): # -> Self@QuerySet:
        """
    ...
    def exclude(self, *args, **kwargs): # -> Self@QuerySet:
        """
    ...
    def complex_filter(self, filter_obj): # -> Self@QuerySet:
        """
    ...
    def union(self, *other_qs, all=...): # -> <subclass of QuerySet and EmptyQuerySet>* | Self@QuerySet:
        ...
    
    def intersection(self, *other_qs): # -> <subclass of QuerySet and EmptyQuerySet>* | EmptyQuerySet | Self@QuerySet:
        ...
    
    def difference(self, *other_qs): # -> <subclass of QuerySet and EmptyQuerySet>* | Self@QuerySet:
        ...
    
    def select_for_update(self, nowait=..., skip_locked=..., of=..., no_key=...): # -> Self@QuerySet:
        """
    ...
    def select_related(self, *fields): # -> Self@QuerySet:
        """
    ...
    def prefetch_related(self, *lookups): # -> Self@QuerySet:
        """
    ...
    def annotate(self, *args, **kwargs): # -> Self@QuerySet:
        """
    ...
    def alias(self, *args, **kwargs): # -> Self@QuerySet:
        """
        Return a query set with added aliases for extra data or aggregations.
        """
        ...
    
    def order_by(self, *field_names): # -> Self@QuerySet:
        """Return a new QuerySet instance with the ordering changed."""
        ...
    
    def distinct(self, *field_names): # -> Self@QuerySet:
        """
        Return a new QuerySet instance that will select only distinct results.
        """
        ...
    
    def extra(self, select=..., where=..., params=..., tables=..., order_by=..., select_params=...): # -> Self@QuerySet:
        """Add extra SQL fragments to the query."""
        ...
    
    def reverse(self): # -> Self@QuerySet:
        """Reverse the ordering of the QuerySet."""
        ...
    
    def defer(self, *fields): # -> Self@QuerySet:
        """
    ...
    def only(self, *fields): # -> Self@QuerySet:
        """
    ...
    def using(self, alias): # -> Self@QuerySet:
...
class RawQuerySet:
    ...
    def prefetch_related(self, *lookups): # -> Self@RawQuerySet:
...
class Prefetch:
    ...
    def get_current_to_attr(self, level): # -> tuple[Unknown | str, Unknown]:
        ...
