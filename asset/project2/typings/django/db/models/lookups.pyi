...
class Lookup(Expression):
    ...
    def batch_process_rhs(self, compiler, connection, rhs=...): # -> tuple[list[str], list[Unknown | Value]]:
        ...
    
    def get_source_expressions(self): # -> list[Unknown | Value]:
        ...
    ...
    @property
    def identity(self): # -> tuple[Type[Self@Lookup], Unknown | Value, Unknown | Value]:
        ...
...
class Exact(FieldGetDbPrepValueMixin, BuiltinLookup):
    ...
    def as_sql(self, compiler, connection): # -> tuple[Unknown, list[Unknown]] | tuple[str, list[Unknown]]:
        ...
...
class Range(FieldGetDbPrepValueIterableMixin, BuiltinLookup):
    lookup_name = ...
    def get_rhs_op(self, connection, rhs): # -> str:
        ...
...
class Regex(BuiltinLookup):
    lookup_name = ...
    prepare_rhs = ...
    def as_sql(self, compiler, connection): # -> tuple[str, list[Unknown]] | tuple[Unknown, Unknown | list[Unknown]]:
        ...
